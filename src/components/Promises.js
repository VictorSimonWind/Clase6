/**JAVASCRIPT ES SINCRONICO Y ES Y SE MANEJA DE UN HILO A LA VEZ*/

/**muchas veses vamos a sentir que muchas cosas ocurren a la vez
 * debido a la velocidad a la que los eventos se disparan, pero
 * los eventos, pero el codigo siempre se lee de arriba hacia abajo,
 * y cuando un bloque de codigo se ejecuta, no hay otro que se ejecute a la vez.
 * 
 * para indagar mas en el tema, puedes leer el articulo debajo
 * 
